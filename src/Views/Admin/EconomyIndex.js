        ...
        <div className='admin_container'>
            ...
            <Row>
                ...
                <Col>
                    <div id='single_line'></div>
                    { 
                        updateCurrencyRateId === null ? <h2>Add New Economy Index Data</h2>
                        : <h2>Update The Economy Index Data</h2> 
                    }
                    <div id='single_line'></div>
                    ...
                    <div id="form_block">
                        ...
                        <Row>
                            ...
                            <Col id="column_center">
                                <h6 style={margin_top} id="column_left">Day</h6>
